<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            {{ Form::label('deptoId') }}
            {{ Form::text('deptoId', $empleado->deptoId, ['class' => 'form-control' . ($errors->has('deptoId') ? ' is-invalid' : ''), 'placeholder' => 'Deptoid']) }}
            {!! $errors->first('deptoId', '<div class="invalid-feedback">:message</div>') !!}
        </div>
